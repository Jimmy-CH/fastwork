...
from customer.models import Customer, Quotation
from service_order.models import WorkOrder, Feedback
from product.models import Category as ProductCategory, Product, BOM
from warehouse.models import PurchaseOrder, Inventory, InventoryTransaction
from mall.models import MallOrder
from ai_chatbot.models import ChatSession, ChatMessage
from message_center.models import Message
from knowledge_base.models import KnowledgeCategory, KnowledgeArticle
